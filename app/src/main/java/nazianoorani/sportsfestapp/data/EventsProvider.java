...
public class EventsProvider extends ContentProvider{
    ...
    private static final String MATCHES_BY_DATE =
            DatabaseContract.match_table.DATE_COL + " LIKE ?";
    ...
    private int match_uri(Uri uri) {
        String link = uri.toString();
        {
            if (link.contentEquals(DatabaseContract.BASE_CONTENT_URI.toString())) {
                return MATCHES;
            } else if (link.contentEquals(DatabaseContract.match_table.buildMatchWithMatchDate().toString())) {
        ...
        switch (match)
        {
            ...
            case MATCHES_WITH_DATE:
                ...
                retCursor = mOpenHelper.getReadableDatabase().query(
                        DatabaseContract.MATCH_TABLE,
                        projection,null,selectionArgs,null,null,sortOrder); break;
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case MATCHES:
                return DatabaseContract.match_table.CONTENT_TYPE;
            case MATCHES_WITH_DATE:
                return DatabaseContract.match_table .CONTENT_TYPE;
        ...
        switch (match_uri(uri))
        {
            case MATCHES:
                ...
                try
                {
                    ...
                    {
                        long _id = db.insert(DatabaseContract.MATCH_TABLE, null, value);
                        if (_id != -1)
                        {
                            returncount++;
                        }
